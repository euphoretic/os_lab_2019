...
void main() {
	...
	init_philosopher(&philosophers[0], "Philos_1", 0, 1);
	init_philosopher(&philosophers[1], "Philos_2", 1, 2);
	init_philosopher(&philosophers[2], "Philos_3", 2, 3);
	init_philosopher(&philosophers[3], "Philos_4", 3, 4);
	init_philosopher(&philosophers[4], "Philos_5", 4, 0);
